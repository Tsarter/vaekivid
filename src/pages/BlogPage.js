        ...
        <div className={classes.TopContainer}>
            <div className={classes.BlogPage}>
                ...
                <div className={classes.mainContent}>
                    ...
                    <p>
                    Kõiki päevi pole õnnistatud päikesepaiste ja helesinise taevaga. Eestis elades ei tule
                    tõenäoliselt mitte kellelegi suure üllatusena, et vahel (või tihti) sajab ka kive. Kuigi kivised
                    päevad võivad tunduda tüütuna, pole vaja oma pead norgu lasta, sest tegelikult pakuvad need ka
                    palju toredaid võimalusi oma aja sisustamiseks. Sellest blogipostitusest leiad kümme tegevust,
                    mida ette võtta siis, kui väljas lihtsalt kallab ja kallab.
                    </p>
                </div>
            </div>
        </div>
